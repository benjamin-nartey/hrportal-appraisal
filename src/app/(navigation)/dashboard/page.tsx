    ...
    <div>
      <div className="flex flex-wrap -m-4 text-center">
        <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
          <div className="border-2 border-teal-400 cursor-pointer px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
            <svg
              fill="none"
              stroke="currentColor"
              ...
              stroke-width="2"
              className="text-teal-400 w-12 h-12 mb-3 inline-block"
              viewBox="0 0 24 24"
            >
